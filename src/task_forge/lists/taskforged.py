...
class List(IList):
    ...
    def __init__(self, unix_socket=None, host=None, port=None, secret_file=None):
    ...
    def add_multiple(self, tasks):
        ...
        """
        return self.__send(
            {"method": "add_multiple", "payload": [task.to_json() for task in tasks]}
        )
    ...
    def find_by_id(self, task_id):
        """Find a task by id."""
        return self.__send({"method": "find_by_id", "payload": {"task_id": task_id}})
    ...
    def complete(self, task_id):
        ...
        return self.__send({"method": "complete", "payload": {"task_id": task_id}})
    ...
    def add_note(self, task_id, note):
        ...
        return self.__send(
            {
                "method": "add_note",
                "payload": {"task_id": task_id, "note": note.to_json()},
            }
        )
