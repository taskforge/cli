...
class TaskListTests:
    ...
    def test_add_multiple(self):
        fixture = [Task("task 1"), Task("task 2"), Task("task 3")]
    ...
    def test_query_simple_title(self):
        fixture = [Task("task 1"), Task("task 2")]
        self.run_query_test(
            query='title = "task 1"', fixture=fixture, expected=[fixture[0]]
        )
    ...
    def test_query_other_context(self):
        ...
        self.run_query_test(
            query="context = other", fixture=fixture, expected=[fixture[2]]
        )
    ...
    def test_completed_true(self):
        ...
        self.run_query_test(
            query="completed = true", fixture=fixture, expected=[fixture[1], fixture[3]]
        )
